...
if (strlen($_SESSION['wsmsuid'] == 0)) {
	...
	<body>
		...
		<div class="super_container">
						...
						<div class="col-lg-12">
							...
							while ($result = mysqli_fetch_array($ret)) {
								...
								<p style="color:#000"><b>Ordet Status :</b>
									...
									(<a href="javascript:void(0);"
										onClick="popUpWindow('trackorder.php?oid=<?php echo $oid; ?>');" title="Track order"
										style="color:#000"> Track order
									</a>)
								</p>
							...
							<p>
								<a href="javascript:void(0);"
									...
									title="Order Invoice" style="color:#000"> Invoice</a>
							</p>
			...
			<div class="payment">
				<div class="pay-page">
					<form action="payment/payment.html" method="get" target="_blank">
						<input type="submit" class="btn-pay" value="Proceed to payment">
