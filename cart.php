		...
		<div class="super_container">
			...
			<div class="home">
				<div class="parallax_background parallax-window" data-parallax="scroll"
					data-image-src="images/wsmsabout.jpg" data-speed="0.8"></div>
				<div class="container">
					<div class="row">
						<div class="col">
								...
								<table border="1" class="table">
									...
									while ($row = mysqli_fetch_array($query)) {
										...
										<tr>
											...
											<td><img class="b-goods-f__img img-scale" src="admin/images/<?php echo $row['Image']; ?>"
													alt="<?php echo $row['Image']; ?>" width='300' height='250'></td>
											<td>
												<?php echo $row['CompanyName']; ?>
											</td>
											<td>
												<?php echo $row['BottleSize']; ?>
											</td>
											<td>Rs.
												<?php echo $total = $row['Price']; ?>
											</td>
											<td><a href="cart.php?delid=<?php echo $row['ID']; ?>"
										...
										<div class="contact_form_container">
											<form action="#" class="contact_form text-center" id="contact_form" method="post"
												...
												<div class="row">
													<div class="col-lg-12" style="margin-top: 15px">
														<input type="text" class="form-control form-control-alternative"
															placeholder="Contact Number" name="cnumber" id="cnumber"
															required="true" style="border:1px #000 solid;" maxlength="10"
															pattern="[0-9]+">
													</div>
												...
												<div class="row">
													<div class="col-lg-12" style="margin-top: 15px">
														<input type="text" class="form-control form-control-alternative"
															placeholder="Street Name" name="streename" id="streename"
															required="true" style="border:1px #000 solid;">
													</div>
												...
												<div class="row">
													<div class="col-lg-12" style="margin-top: 15px">
														<input type="text" class="form-control form-control-alternative"
															placeholder="Area" name="area" id="area" required="true"
												...
												<div class="row">
													<div class="col-lg-12" style="margin-top: 15px">
														<input type="text" class="form-control form-control-alternative"
															placeholder="City" name="city" id="city" required="true"
															style="border:1px #000 solid;">
													</div>
